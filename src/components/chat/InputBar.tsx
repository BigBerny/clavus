...
export function InputBar({ onSend, onAbort, isStreaming, onRecordingChange }: Props) {
  ...
  return (
    <div className="border-t border-surface-light-3/40 dark:border-surface-dark-3/40 shadow-[0_-2px_8px_rgba(0,0,0,0.04)] dark:shadow-[0_-2px_8px_rgba(0,0,0,0.15)] bg-surface-light/98 dark:bg-surface-dark/98 backdrop-blur-xl" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
