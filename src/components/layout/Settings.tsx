...
export function Settings() {
  const { settingsOpen, setSettingsOpen, themeChoice, setThemeChoice, gatewayUrl, setGatewayUrl } = useUIStore()
  ...
  return (
    <>
      ...
      />
      <div className="fixed right-0 top-0 bottom-0 w-80 max-w-[85vw] bg-surface-light dark:bg-surface-dark z-50 shadow-xl flex flex-col animate-[slideIn_0.2s_ease-out]">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <section>
            ...
            <div className="flex gap-1 bg-surface-light-2 dark:bg-surface-dark-2 p-1 rounded-lg">
          ...
          {/* Gateway URL */}
          <section>
            <label className="block text-sm font-medium text-text-light dark:text-text-dark mb-2">Gateway URL</label>
